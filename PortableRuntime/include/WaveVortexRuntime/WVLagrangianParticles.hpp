...
struct WVLagrangianParticleMetrics {
...
// all particle systems share one moving-position primitive-field transform.
...
public:
  ...
  const WVLagrangianParticleMetrics &metrics() const noexcept {
    return metrics_;
  }
...
private:
  ...
  WVLagrangianParticleMetrics metrics_;
