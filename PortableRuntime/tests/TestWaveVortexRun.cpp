...
int main() {
    try {
        ...
        require(rk78ReportText.find("\"id\":\"adaptive-rk78\"") != std::string::npos && rk78ReportText.find("\"controller\":\"matlab-ode78-v1\"") != std::string::npos && rk78ReportText.find("\"workspaceStateEquivalentCount\":11") != std::string::npos && rk78ReportText.find("\"workspaceMaximumLiveStateEquivalentCount\":11") != std::string::npos && rk78ReportText.find("\"denseHistoryStateEquivalentCount\":0") != std::string::npos && rk78ReportText.find("\"retainedBaseStageStateEquivalentCount\":0") != std::string::npos && rk78ReportText.find("\"continuousExtensionRightHandSideEvaluationCount\":0") != std::string::npos && rk78ReportText.find("\"continuousExtensionWorkspaceMaximumLiveBytes\":0") != std::string::npos && rk78ReportText.find("\"buffer\":\"k2/k3/k5\"") != std::string::npos && rk78ReportText.find("\"errorPolicyBytes\":") != std::string::npos,"adaptive RK78 runner report omitted method or exact endpoint-only memory diagnostics");
        ...
        require(rk78DenseReportText.find("\"denseOutputEvaluationCount\":2") != std::string::npos && rk78DenseReportText.find("\"interpolatedOutputCount\":2") != std::string::npos && rk78DenseReportText.find("\"continuousExtensionRightHandSideEvaluationCount\":8") != std::string::npos && rk78DenseReportText.find("\"denseOutputCacheBuildCount\":2") != std::string::npos && rk78DenseReportText.find("\"denseOutputCacheReuseCount\":0") != std::string::npos && rk78DenseReportText.find("\"retainedBaseStageStateEquivalentCount\":8") != std::string::npos && rk78DenseReportText.find("\"continuousExtensionWorkspaceStateEquivalentCount\":4") != std::string::npos && rk78DenseReportText.find("\"continuousExtensionWorkspaceMaximumLiveStateEquivalentCount\":4") != std::string::npos && rk78DenseReportText.find("\"workspaceMaximumLiveStateEquivalentCount\":15") != std::string::npos,"adaptive RK78 runner did not report lazy dense-output work or storage");
