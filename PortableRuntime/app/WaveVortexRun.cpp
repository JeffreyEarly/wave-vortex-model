...
int main(int argc, char** argv) {
    ...
    const auto integratorElementReads = integratorMetrics.stageStateConstructionElementReads+integratorMetrics.weightedFluxInitializationElementReads+integratorMetrics.weightedAccumulationElementReads+integratorMetrics.finalStateUpdateElementReads;
