...
configuration = struct( ...
    ...
    "representativeNj",options.representativeNj, ...
...
config = struct( ...
    ...
    "representativeNj",configuration.representativeNj, ...
...
wvt = WVTransformFreeSurfaceQG(definition.Lxyz,definition.Nxyz, ...
    ...
    apvModeCount=definition.Nj,mdaModeCount=definition.Nj,mdaGramTolerance=configuration.mdaGramTolerance);
...
value = struct( ...
    ...
    "commonCertifiedModeCount",min(wvt.apvCertifiedModeCount,wvt.mdaCertifiedModeCount), ...
