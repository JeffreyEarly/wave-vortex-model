...
arguments
    ...
    options.mdaGramTolerance (1,1) double {mustBeReal,mustBeFinite,mustBeNonnegative} = 0.1
...
configuration = struct( ...
    ...
    "mdaGramTolerance",options.mdaGramTolerance,"Lxyz",options.Lxyz, ...
...
config = struct( ...
    ...
    "mdaGramTolerance",configuration.mdaGramTolerance,"Lxyz",configuration.Lxyz, ...
...
wvt = WVTransformFreeSurfaceQG(definition.Lxyz,definition.Nxyz, ...
    ...
    mdaGramTolerance=configuration.mdaGramTolerance);
...
value = struct( ...
    ...
    "apvGramTolerance",wvt.apvGramTolerance, ...
    "mdaGramTolerance",wvt.mdaGramTolerance, ...
    ...
    "apvZeroAPVQuadraticError",wvt.apvZeroAPVQuadraticError);
end
