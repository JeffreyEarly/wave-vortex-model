...
arguments
    ...
    options.issue158InPlaceArena (1,1) logical = false
end
if options.issue158InPlaceArena && options.issue130Variant ~= 3, error("WaveVortexModel:Issue158Variant","The issue #158 arena requires issue130Variant=3."); end
...
compilerFlags = "CXXFLAGS=$CXXFLAGS -std=c++17 -pthread -O3 -mcpu=native" + ...
    ...
    " -DWV_KERNEL_ISSUE158_INPLACE_ARENA="+double(options.issue158InPlaceArena);
