...
function record = environmentRecord(threads), record = struct("os",string(system_dependent("getos")),"processor",string(system_dependent("getcpu")),"matlabVersion",string(version),"matlabRelease",string(version("-release")),"architecture",string(computer("arch")),"threads",threads,"fftwLibrary",fullfile(matlabroot,"bin",computer("arch"),"libmwfftw3.3.dylib")); end
