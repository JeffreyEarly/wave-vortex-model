...
| Package/scope/whitespace checks | Manifest unchanged; runtime files use existing installed roots; no snapshot, historical experiment, handwritten website or generated binary changes; local evidence links and whitespace pass. Install/export consumer results are recorded on PR #525. |
