...
**Review status, 10 September:** this describes PR #459's alternative constrained weak discretization. It is not the accepted direct manuscript projection. See the [pressure-revision comparison](manuscript-projection-comparison.md); the PR remains draft while the direct approach is assessed. Earlier qualification results apply to this alternative only.
