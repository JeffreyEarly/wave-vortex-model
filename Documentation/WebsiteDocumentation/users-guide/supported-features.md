...
WaveVortexModel provides five production transform families and a free-surface QG transform with independently retained APV and MDA families, nonlinear horizontal advection, and durable persistence. This page summarizes the documented public behavior and important limitations. Public MATLAB visibility alone does not make an implementation helper a recommended entry point.
...
| `WVTransformFreeSurfaceQG` | Free-surface QG construction, projection, nonlinear QGPV and endpoint advection, reconstruction, snapshots, output, and restart. |
...
| --- | --- | --- | --- |
| Transform families | All five production transforms, including free-surface QG representation, persistence, and nonlinear horizontal advection | Constant stratification | Constant stratification and equivalent-barotropic QG |
