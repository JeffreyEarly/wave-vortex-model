...
- `tools/qualifyThermalAPVDiagnostics.m`, `UnitTests/TestThermalAPVDiagnostics.m`, and `Documentation/Validation/Issue440/`: reproducible qualification, tests and evidence.
