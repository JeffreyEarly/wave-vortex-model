...
- Implemented engine-neutral fused constant-stratification projection, reconstruction, and field/derivative transforms in the portable C++ core, with an authoring-only FFTW adapter for validation; nonlinear products and public backend selection remain future work.
