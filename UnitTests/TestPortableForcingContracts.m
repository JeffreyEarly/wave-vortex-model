classdef TestPortableForcingContracts < matlab.unittest.TestCase
    ...
    methods (Test, TestTags={'full'})
        ...
        function supportedForcingsReturnExactVersionedContracts(testCase)
            ...
            unfiltered = WVTransformConstantStratification([1000 1000 100],[8 6 5],N0=5.2e-3,shouldAntialias=false);
            forcings = {
                ...
                WVAntialiasing(unfiltered),WVHorizontalDamping(testCase.wvt), ...
                WVVerticalDamping(testCase.wvt),WVVerticalDiffusivity(testCase.wvt)};
            expected = ["WVNonlinearAdvection" "WVAdaptiveDamping" "WVFixedAmplitudeForcing" "WVBottomFrictionLinear" "WVBottomFrictionQuadratic" "WVPseudoTopographicWaveGeneration" "WVBetaPlanePVAdvection" "WVAntialiasing" "WVHorizontalDamping" "WVVerticalDamping" "WVVerticalDiffusivity"];
