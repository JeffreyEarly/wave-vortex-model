classdef TestFreeSurfaceBulkConstruction < matlab.unittest.TestCase
    ...
    methods (Test, TestTags="full")
        function bulkConstructionPreservesResolvedRepresentation(testCase,profile)
            ...
            bulk = WVTransformFreeSurfaceBoussinesq.fromStratification([1e5 8e4 1000],[16 12 65],shouldAntialias=true,N2Function=N2,waveModeCount=waveCount,inertialModeCount=inertialCount,apvModeCount=3,mdaModeCount=2);
