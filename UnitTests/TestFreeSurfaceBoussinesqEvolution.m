classdef TestFreeSurfaceBoussinesqEvolution < matlab.unittest.TestCase
    methods (Test, TestTags="full")
        ...
        function endpointConfigurationsRoundTrip(testCase)
            ...
            for endpoints=[Inf Inf;.02 Inf;Inf .03;.02 .03].'
                w=WVTransformFreeSurfaceBoussinesq.fromStratification([1e5 1e5 1000],[8 8 65],N2Function=@(z)1e-4+0*z,g0=endpoints(1),gd=endpoints(2));
    ...
    methods (Static)
        ...
        function w=newTransform(profile)
            ...
            w=WVTransformFreeSurfaceBoussinesq.fromStratification([1e5 1e5 1000],[8 8 65],N2Function=N2);
        end
