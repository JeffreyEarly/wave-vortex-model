...
isDeveloper = false;
if name == className || (className == "WVThermalAPVDamping" && name == "fromAPVTransform")
    topicPath = "Create the forcing";
elseif className == "WVThermalAPVDamping" && ismember(name,["apvZ","dampingAPVMode", ...
        "apvForward","apvInverseLr2","apvEndpointNumerator","apvVerticalRates", ...
        "dampingEndpoint","horizontalResolution","horizontalCutoff", ...
        "sourceN20","sourceInverseScale","sourceDepth","sourceLatitude","sourceGravity","sourceG0","sourceGd"])
...
tf = className == "WVForcing" || startsWith(className,"WVBottomFriction") || ...
    ...
    "WVVerticalDamping","WVThermalDamping","WVAntialiasing","WVThermalAPVDamping"]);
end
