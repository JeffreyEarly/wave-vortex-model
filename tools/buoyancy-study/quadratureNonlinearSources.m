function [u,v,w,eta] = quadratureNonlinearSources(self,thermodynamics)
...
hatted = struct(u=fields.u_hat,v=fields.v_hat,w=fields.w_hat,eta=fields.eta,p=fields.p,ssh=fields.ssh);
