...
require(string(packageBefore.ReleaseCompatibility) == ">=R2025a", ...
    "The export dry run requires MATLAB R2025a as the package compatibility floor.");
...
require(string(exportPackage.ReleaseCompatibility) == ">=R2025a", ...
    "The exported package does not retain the MATLAB R2025a compatibility floor.");
