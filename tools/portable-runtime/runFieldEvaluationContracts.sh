...
if command -v cmake >/dev/null 2>&1; then
    ...
    cmake --build "$build_directory" --parallel --target TestWVFieldEvaluation TestWVModelOutputNetCDF wv_field_evaluation_inspect wv_lagrangian_particle_inspect wv_tracer_inspect
