function terms = evaluateManuscriptNonlinearTerms(hatted,pressure,xi,D,f,rho0,N2,integratedN2,derivative)
% Evaluate Appendix C terms before applying any modal source projector.
%
% Study-local transcription of eq:projection-ready-nonlinear-advection-terms,
...
if any(gamma<=0,'all')
    error('WVStudy:ManuscriptGeometry','The manuscript map requires positive gamma.')
end
