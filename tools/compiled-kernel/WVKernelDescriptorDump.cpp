...
int main(int argc, char** argv) {
    ...
    std::cout << ",\"inverseFg\":"; numericArray(descriptor.verticalModes().inverseFg);
    std::cout << ",\"inverseGg\":"; numericArray(descriptor.verticalModes().inverseGg);
    std::cout << ",\"inverseGwg\":"; numericArray(descriptor.verticalModes().inverseGwg);
    std::cout << ",\"deltaScale\":"; numericArray(descriptor.verticalModes().deltaScale);
