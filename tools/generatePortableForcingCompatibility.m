...
for row = matrix.rows
    ...
    lines(end+1) = "  {"""+row.forcing+""", "+cppBoolean(startsWith(row.configuration,"barotropic"))+", "+cppBoolean(startsWith(row.configuration,"stratified-qg"))+", "+cppBoolean(startsWith(row.configuration,"hydrostatic"))+", "+cppBoolean(endsWith(row.configuration,"aa1"))+", "+ ...
