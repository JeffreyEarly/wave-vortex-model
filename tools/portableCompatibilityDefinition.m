...
matrix=struct(schema="portable-compatibility-matrix-v1",schemaVersion=1,slice="standard",completion=completion, ...
    readiness=struct(standardParityReady=true,decision="STANDARD-PORTABLE-PARITY",meaning="Executed standard parity qualification is bound by the final #307 decision receipt; the assembly still requires zero unqualified rows."), ...
