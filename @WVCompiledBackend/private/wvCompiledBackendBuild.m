...
runtimeSources = fullfile(constants.runtimeSourceDirectory,[ ...
    ...
    "WVModel.cpp"]);
requiredSources = [string(gateway);string(engine);fullfile(constants.adapterDirectory,"WVNativeFFTWEngine.hpp");fullfile(constants.coreSourceDirectory,"WVKernelTypes.cpp");fullfile(constants.coreSourceDirectory,"WVTransformConstantStratificationKernel.cpp");fullfile(constants.runtimeIncludeDirectory,"WaveVortexRuntime","WVExtensionCatalog.hpp");runtimeSources];
