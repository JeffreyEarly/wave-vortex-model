...
requiredSources = [string(gateway);string(engine);fullfile(constants.adapterDirectory,"WVNativeFFTWEngine.hpp");fullfile(constants.coreSourceDirectory,"WVKernelTypes.cpp");fullfile(constants.coreSourceDirectory,"WVTransformConstantStratificationKernel.cpp");runtimeHeaders;runtimePrivateHeaders;runtimeSources];
