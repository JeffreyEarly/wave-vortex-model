...
- Broad hosted run 34248386552 passed all 411 selected numerical tests on both R2025b and R2026a, plus 137 smoke tests per release. Serial numerical work alone took 1,556/1,598 seconds. The selected sanitizer failure made the real aggregate and all three legacy aliases fail, providing hosted negative-gate evidence.
