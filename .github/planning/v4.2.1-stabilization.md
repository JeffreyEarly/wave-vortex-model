...
- Review the changelog for every user-visible bug fix, deprecation, dependency change, or support clarification.
- Verify package name, version, dependencies, folder list, release compatibility, and schema through the public MPM API.
- Confirm the release contains no new scientific capability, broad refactor, or unannounced breaking API change.
