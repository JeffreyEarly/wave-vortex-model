...
for provider=["reference","native-fftw"]
    report=collectPortableForwardIntegrationQualification("/private/tmp/wvm391-density-output-forward-refresh-evidence",provider,repositoryRoot=root);
...
file=fopen('/private/tmp/wvm391-density-output-forward-catalog-results.json','w');
