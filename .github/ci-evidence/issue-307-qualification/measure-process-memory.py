...
def main(args):
    ...
    result = {"schema": "wave-vortex-process-memory-qualification-v1",
              ...
              "peakAuthority": "parent wait4 child exit ru_maxrss; complete child lifetime, bytes on macOS and KiB converted to bytes on Linux",
    ...
    for family in ("constant", "hydrostatic", "boussinesq"):
        ...
        for repetition in range(5):
            ...
            for label in order:
                ...
                item = {"peakRSSBytes": int(usage.ru_maxrss) * (1 if sys.platform == "darwin" else 1024),
                        "reportedPostintegrationPeakRSSBytes": value["rssBytes"]["processPeak"],
