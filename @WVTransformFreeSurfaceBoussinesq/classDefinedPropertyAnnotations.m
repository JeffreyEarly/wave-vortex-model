...
annotations(end+1) = CAPropertyAnnotation('fieldConvention','physical field and parcel thermodynamic convention');
...
names = {'waveModeNumber','inertialModeNumber','mdaPressureMode','waveF','waveG','waveGForward','waveEquivalentDepth','waveFrequency','inertialF','inertialFForward','inertialEquivalentDepth','waveGramError','inertialGramError','balancedNEVP','nEVP'};
...
units = {'1','1','m s-2','1','1','1','m','rad s-1','1','1','m','1','1','1','1'};
