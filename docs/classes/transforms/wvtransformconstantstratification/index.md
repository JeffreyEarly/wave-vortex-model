...
+ Inspect the domain
  + Physical environment
    ...
    + Stratification and reference density
      ...
      + [`shouldUseTrueNoMotionProfile`](/classes/transforms/wvtransformconstantstratification/shouldusetruenomotionprofile.html) Whether density diagnostics use the diagnosed current no-motion profile.
    + Gravity
  ...
  + Transform configuration
    + [`computationalBackend`](/classes/transforms/wvtransformconstantstratification/computationalbackend.html) Runtime numerical backend. MATLAB remains the default.
    + [`computationalBackendMetadata`](/classes/transforms/wvtransformconstantstratification/computationalbackendmetadata.html) Provider identity, storage and execution metrics for this transform.
