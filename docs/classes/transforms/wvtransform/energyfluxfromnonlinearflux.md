...
+ `E0_A`  energy flux into the A0 coefficients if three return variables are requested, or returns the kinetic energy flux if four return variables are requested.
+ `E0_B`  potential energy flux into the A0 coefficients
