...
struct WVKernelMetrics {
    ...
    double modalReconstructionSeconds = 0.0;
    double modalDerivativeSeconds = 0.0;
    double modalProjectionSeconds = 0.0;
};
...
public:
    ...
    const char* modalCoefficientModeIdentifier() const noexcept;
    const char* optimizationImplementationIdentifier() const noexcept;
    std::size_t modalWorkerCount() const noexcept;
