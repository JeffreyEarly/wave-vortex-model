...
- Unforced nonlinear hydrostatic advection, including `w*(eta_z + eta*dLnN2)` in the displacement tendency, projected back into reference-time amplitudes. Forcing composition and integrator/observer services remain runtime work.
